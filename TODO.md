...
- [ ] ⚠️ 1145 Washington Blvd Ogden OM PDF is now STALE — page 3 still says "Purchase Price: $1,690,000". The website was dropped to $1,550,000 on 2026-08-25 (commit f4f1e63). The PDF at `oms/1145-s-washington-blvd-ogden-om.pdf` is linked from the listing card AND the detail page, so buyers see the old number. Also needs updating on Crexi (property 2632420) and anywhere else it is posted.
