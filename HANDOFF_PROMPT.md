...
- **Auth fallback:** if wincred grabs the wrong GitHub account and returns 403 ("denied to [redacted]"), use the username-qualified URL: `git -c credential.helper=wincred push https://farnsworthstockton-arch@github.com/farnsworthstockton-arch/teamutahcommercial.git main`
